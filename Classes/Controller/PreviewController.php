 ...
 * page as the site renders it, in the reviewed workspace or in its base
 * workspace. While this controller renders, Root.fusion marks every content
 * element with its node identifier, so the review can place change markers on
 * the page.
 *
